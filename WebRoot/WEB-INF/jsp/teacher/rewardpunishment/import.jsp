...
<body>
	...
	<!-- 表单区 -->
	<form action="tea/tearewardPunishmentAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="tea/tearewardPunishmentAction_exportTemplate.action">《教师奖惩记录导入模板》</a>
			</div>
		</div>
	...
	function uploadResult() {
		...
		if (code == 0) {
			var message = "共导入" + total + "条数据!，其中" + updateCount
					+ "条学生信息不存在保存无效，有效信息" + insertCount + "条。";
