...
<body>
	...
	<!-- 表单区 -->
	<form action="tea/trainInfoDetailAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="tea/trainInfoDetailAction_exportTemplate.action">《学生培训情况明细导入模板》</a>
			</div>
		</div>
	...
	function uploadResult() {
		...
		if (code == 0) {
			var message = "共导入" + total + "条数据!，其中" + updateCount
					+ "条信息（培训编号或学号）不存在保存无效，有效信息" + insertCount + "条。";
