...
<body>
	...
	<!-- 表单区 -->
	<form action="tea/attendanceMasterAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;"
					href="tea/attendanceMasterAction_exportTemplate.action">《学生考勤登记表导入模板》</a>
			</div>
		</div>
	...
	function uploadResult() {
		...
		if (code == 0) {
			...
			var message = "共导入" + total + "条数据!，其中" + updateCount
					+ "条信息（培训编号）已存在保存无效，有效信息" + insertCount + "条。";
			...
			$.messager.alert('操作提示', "已存在考勤表或格式异常!", 'info', function() {
				doClose();
			});
		}
	}
