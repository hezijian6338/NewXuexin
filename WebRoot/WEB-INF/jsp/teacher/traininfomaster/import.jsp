...
<body>
	...
	<!-- 表单区 -->
	<form action="tea/trainInfoMasterAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="tea/trainInfoMasterAction_exportTemplate.action">《学生培训情况主表导入模板》</a>
			</div>
		</div>
