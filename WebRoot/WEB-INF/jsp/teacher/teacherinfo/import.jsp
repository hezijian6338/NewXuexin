...
<body>
	...
	<!-- 表单区 -->
	<form action="tea/teacherInfoAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="tea/teacherInfoAction_exportTemplate.action">《教师基本信息导入模板》</a>
			</div>
		</div>
	...
	function uploadResult() {
		...
		if (code == 0) {
			var message = "共导入" + total + "条数据!，其中" + updateCount
					+ "条教师信息编号已存在保存无效，有效信息" + insertCount + "条。";
