					...
					<td>
						<div style="width: 350px;">
							...
							<div class="edit_winRow">
								...
								<div class="edit_right">
									<input id="telno" type="text" class="easyui-numberbox l_textbox"
										name="telno" data-options="min:0" value="">
								</div>
							</div>
							<div class="edit_winRow">
					...
					<td>
						...
						<div style="width: 350px;">
							...
							<div class="edit_winRow">
								...
								<div class="edit_right">
									<input type="radio" class="radio-style" name="invigilatorflag" id="invigilatorflag0"
										value="T" checked="checked" />可以<input type="radio" id="invigilatorflag1"
										class="radio-style" name="invigilatorflag" value="F" />不可以
								</div>
							</div>
							<div class="edit_winRow">
							...
							<div class="edit_winRow">
								...
								<div class="edit_right">
									<input type="radio" class="radio-style" name="qualificationflag" id="qualificationflag0"
										value="Y" checked="checked" />有<input type="radio" id="qualificationflag1"
										class="radio-style" name="qualificationflag" value="N" />无
								</div>
							</div>
							<div class="edit_winRow">
								<div class="edit_left">在职状态:</div>
								<div class="edit_right">
									<input type="radio" class="radio-style" name="jobstatus" id="jobstatus0"
										value="Y" checked="checked" />在职<input type="radio" id="jobstatus1"
										class="radio-style" name="jobstatus" value="N" />离职
								</div>
							</div>
							<div class="edit_winRow">
							...
							<div class="edit_winRow">
								<div class="edit_left">是否实验<br>室人员:</div>
								<div class="edit_right">
									<input type="radio" class="radio-style" name="islab" id="islab0"
										value="Y" />是<input type="radio" id="islab1"
										class="radio-style" name="islab" value="N" checked="checked" />否
								</div>
							</div>
							<div class="edit_winRow">
								<div class="edit_left">是否外聘:</div>
								<div class="edit_right">
									<input type="radio" class="radio-style" name="isouthire" id="isouthire0"
										value="Y" />是<input type="radio" id="isouthire1"
										class="radio-style" name="isouthire" value="N" checked="checked" />否
								</div>
							</div>
							<div class="edit_winRow">
				...
				<tr>
					<td valign="top">
						<div class="edit_winRow">
							...
							<div class="edit_right">
								<textarea class="l_textarea" id="researchdirection" name="researchdirection"
...
<script type="text/javascript">
	...
	function doSave() {
		if ($('#addForm').form('validate')) {
			$.post("tea/teacherInfoAction_save.action", $("#addForm")
