...
<body>
	...
	<!-- 表单区 -->
	<form action="stu/commonScholarshipAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="stu/commonScholarshipAction_exportTemplate.action">《普通奖学金导入模板》</a>
			</div>
		</div>
	...
	function uploadResult() {
		...
		if (code == 0) {
			...
			$.messager.alert('操作提示', message, 'info', function() {
				...
				if (isNotNull == 1) {
					$.messager.alert('操作提示', "导入失败：导入文件的除'备注'字段外，所有字段值不能为空", 'info', function() {
