...
<body>
	...
	<!-- 表单区 -->
	<form action="stu/rewardPunishmentAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="stu/rewardPunishmentAction_exportTemplate.action">《学生奖惩记录导入模板》</a>
			</div>
		</div>
