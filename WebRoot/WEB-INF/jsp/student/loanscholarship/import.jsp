...
<body>
	...
	<!-- 表单区 -->
	<form action="stu/loanScholarshipAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="stu/loanScholarshipAction_exportTemplate.action">《贷款表格导入模板》</a>
			</div>
		</div>
