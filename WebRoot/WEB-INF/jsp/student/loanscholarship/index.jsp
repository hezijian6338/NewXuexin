...
<body>
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'north',height:100">
			<div class="nav">
				<div class="nav_left">奖助贷管理&nbsp;&gt;&gt;&nbsp;学生贷款管理</div>
			</div>
			...
			<table id="dg" style="height:200px">
				<thead>
					<tr>
						...
						<th data-options="field:'classname',width:150">班级</th>
						<th data-options="field:'idcardno',width:150">身份证号</th>
...
<script type="text/javascript">
	...
	function onAdd() {
		initWindow("dg_add","新增贷款信息",750,400,"stu/loanScholarshipAction_viewAdd.action");
	}
	...
	function importStuents() {
		initWindow("dg_import","导入贷款信息",450,200,"stu/loanScholarshipAction_viewImport.action"); 
	}
	
	//导出
	function exportStudents(){
		queryForm.action="stu/loanScholarshipAction_exportExcelList.action";
		queryForm.submit();
	}
