							...
							<div class="edit_winRow">
								...
								<div class="edit_right">
									<input type="radio" class="radio-style" name="censoredflag"
										id="censoredflag0" value="Y" />是 <input
...
<script type="text/javascript">
	...
	function loadData() {
		$.post("stu/loanScholarshipAction_getLoanScholarship.action", {
			lsId : id
			...
			if (json.status == "ok") {
				...
				$('#loanamount').val(o.loanamount);
				$('#academicyear').val(o.academicyear);
				$('#term').val(o.term);
				if (o.censoredflag == "Y") {
					$('#censoredflag0').attr("checked", "checked");
				} else {
					$('#censoredflag1').attr("checked", "checked");
				}
				$('#refusereason').val(o.refusereason);
				$('#memo').val(o.memo);
			} else {
				$.messager.show({
					title : '提示信息',
	...
	function doSave() {
		if ($('#editForm').form('validate')) {
			$.post("stu/loanScholarshipAction_update.action?studentno="
