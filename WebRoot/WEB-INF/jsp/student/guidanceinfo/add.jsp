							...
							<div class="edit_winRow">
								...
								<div class="edit_right">
									<input id="guiddateStr" type="text"
										...
										data-options="formatter:myformatter,parser:myparser,required:true,missingMessage:'辅导时间必填!'" value="">
								</div>
							</div>
...
<script type="text/javascript">
	...
	function doSave() {
		if ($('#addForm').form('validate')) {
			$.post("stu/guidanceInfoAction_save.action", $("#addForm")
