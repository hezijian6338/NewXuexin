...
<body>
	...
	<!-- 表单区 -->
	<form action="stu/familyInfoAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="stu/familyInfoAction_exportTemplate.action">《家庭信息导入模板》</a>
			</div>
		</div>
	...
	function uploadResult() {
		...
		if (code == 0) {
			var message = "共导入" + total + "条数据!，其中" + updateCount
					+ "条无效信息或学号不存在已被处理，有效信息" + insertCount + "条。";
