...
<body>
	...
	<!-- 表单区 -->
	<form action="stu/learningGuidInfoAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="stu/learningGuidInfoAction_exportTemplate.action">《导学内容导入模板》</a>
			</div>
		</div>
	...
	function uploadResult() {
		...
		if (code == 0) {
			var message = "共导入" + total + "条数据!，其中" + updateCount
					+ "条重复信息或"+ updateCount+"条非您导学学生已被处理，有效信息" + insertCount + "条。";
