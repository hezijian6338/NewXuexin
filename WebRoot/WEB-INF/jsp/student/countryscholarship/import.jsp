...
<body>
	...
	<!-- 表单区 -->
	<form action="stu/countryScholarshipAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="stu/countryScholarshipAction_exportTemplate.action">《国家光大奖学金导入模板》</a>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function uploadResult() {
		var isNotNull=document.uploadFrame.isNotNull;
		...
		if (code == 0) {
			var message = "共导入" + total + "条数据!，其中" + updateCount
					+ "条基础信息不存在保存无效，"+existCount+"条重复信息保存无效，"+"有效信息" + insertCount + "条。";
			$.messager.alert('操作提示', message, 'info', function() {

					if (isNotNull == 1) {
					$.messager.alert('操作提示', "导入失败：导入文件'学号，学年，学期'字段值不能为空", 'info', function() {
