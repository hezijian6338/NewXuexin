...
<body>
	...
	<!-- 表单区 -->
	<form action="stu/enrollTransactionAction_importFile" method="post"
		...
		<div class="edit_winRow">
			...
			<div class="edit_right">
				<a style="text-decoration: none;" href="stu/enrollTransactionAction_exportTemplate.action">《学籍异动导入模板》</a>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function uploadResult() {
		...
		var exceptionCount=document.uploadFrame.exceptionCount;
		if (code == 0) {
			var message = "共导入" + total + "条数据!，其中" + infoIsNullCount
					+ "条学生信息不存在保存无效，"+existCount+"条重复信息保存无效，"+exceptionCount+"条异常信息,"+"导入有效信息" + insertCount + "条。";
