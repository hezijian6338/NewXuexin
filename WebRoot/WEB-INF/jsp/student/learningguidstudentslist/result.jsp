...
<script type="text/javascript">
	...
	$(function() {	
		$('#dg').datagrid({
			idField : 'id',
			loadMsg : '数据加载中请稍后……',
			url : 'tea/teaScoreConfirmAction_getCheckScoreListByStudentInfo.action',
			queryParams:{stuno:'${param.studentno}',academicyear:'${param.academicyear}',semester:'${param.semester}',},
			lines : true,
			animate : true,
