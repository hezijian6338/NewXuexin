...
<script type="text/javascript">
	...
	function loadData() {
		$.post("stu/subjectContestAction_getSubjectContest.action", {
			sid : id
			...
			if (json.status == "ok") {
				...
				$('#rewardlevel').val(o.rewardlevel);
				$('#rewardgrade').val(o.rewardgrade);
				$('#grantunits').val(o.grantunits);
				$('#rewardproject').val(o.rewardproject);
				$('#guidteacher').val(o.guidteacher);
				$('#academicyear').val(o.academicyear);
				$('#term').val(o.term);
				$('#rewarddate').datebox('setValue', formatShortDate(o.rewarddate));
				$('#memo').val(o.memo);
			} else {
				$.messager.show({
					title : '提示信息',
	...
	function doSave() {
		if ($('#editForm').form('validate')) {
			$.post("stu/subjectContestAction_update.action?studentno="+$('#studentno').val(), $("#editForm")
