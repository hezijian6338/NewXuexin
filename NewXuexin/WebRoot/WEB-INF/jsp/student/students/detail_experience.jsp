...
<script type="text/javascript">
	...
	$(function() {
		$('#dg').datagrid({
			idField : 'id',
			loadMsg : '数据加载中请稍后……',
			url : 'stu/learningExperienceAction_getList.action',
			lines : true,
			animate : true,
	...
	function onUpdate() {
		...
		var id = arr[0].id;
		initWindow("dg_add", "修改学习经历信息", 750, 400,
				"stu/learningExperienceAction_viewEdit.action?id=" + id);
	}
		...
		if (arr.length <= 0) {
			...
			$.messager.confirm("提示信息", "确认删除?", function(r) {
				if (r) {
					...
					$.post("stu/learningExperienceAction_delete.action", {
						ids : ids
