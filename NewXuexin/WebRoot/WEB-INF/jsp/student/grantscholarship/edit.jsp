...
<script type="text/javascript">
	...
	function loadData() {
		$.post("stu/grantScholarshipAction_getGrantScholarship.action", {
			gsId : id
			...
			if (json.status == "ok") {
				...
				$('#nation').val(o.nation);
				$('#acceptancedate').val(o.acceptancedate);
				$('#familyeconomic').val(o.familyeconomic);
				$('#academicyear').val(o.academicyear);
				$('#term').val(o.term);
				$('#reportdate').datebox('setValue', formatShortDate(o.reportdate));
				$('#memo').val(o.memo);
			} else {
				$.messager.show({
					title : '提示信息',
	...
	function doSave() {
		if ($('#editForm').form('validate')) {
			$.post("stu/grantScholarshipAction_update.action", $("#editForm")
