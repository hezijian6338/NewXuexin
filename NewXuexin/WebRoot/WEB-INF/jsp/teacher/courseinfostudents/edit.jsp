					...
					<td>
						<div style="width: 350px;">
							...
							<div class="edit_winRow">
								...
								<div class="edit_right">
									<input id="selectedCoureNo" type="text"
										class="easyui-validatebox l_textbox" name="selectedCoureNo"
										data-options="required:true,missingMessage:'选课课号必填!'" value="">
								</div>
							</div>
							...
							<div class="edit_winRow">
								...
								<div class="edit_right">
									<input id="orgName" type="text"
										class="easyui-combotree l_textbox" name="orgName"
	...
	function loadData() {
		$.post("tea/courseInfoStudentsAction_getCourseInfoStudents.action", {
			...
			if (json.status == "ok") {
				...
				$('#orgName').combotree('setValue', o.orgName);
				$("#selectedCoureNo").val(o.selectedCoureNo);
				$("#term").val(o.term);
