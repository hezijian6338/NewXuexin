 ...
 * 来源：http://www.senamion.com
 * 修改人：Van
 * 修改时间：2012-08-19 上午9:00
 * 使用说明：
 */
	...
	var methods = {
		init : function(options) {
			...
			return this.each(function () {
				...
				/**
				* Sort 排序
				* Move on top selected option 选定选项移动到顶部
				* Move up selected option 向上移动选定的选项
				* Move down selected option 向下移动选定的选项
				* Move on bottom selected option 选定选项移动到底部
				*/
				var divUpDown =
						"<div class='ms2side__updown'>" +
							"<p class='SelSort' title='排序'>" + o.labelSort + "</p>" + 
							"<p class='MoveTop' title='选定选项移动到顶部'>" + o.labelTop + "</p>" +  
							"<p class='MoveUp' title='向上移动选定的选项'>" + o.labelUp + "</p>" + 
							"<p class='MoveDown' title='向下移动选定的选项'>" + o.labelDown + "</p>" + 
							"<p class='MoveBottom' title='选定选项移动到底部'>" + o.labelBottom + "</p>" + 
						"</div>";

				// INPUT TEXT FOR SEARCH OPTION(输入文本搜索选项)
				var	leftSearch = false, rightSearch = false;
				// BOTH SEARCH AND OPTGROUP SEARCH(左右搜索与组搜索)
				...
				// CREATE NEW ELEMENT (AND HIDE IT) AFTER THE HIDDED ORGINAL SELECT (创建新元素.....)
				/**
				* Add Selected 添加所选
				* Add All 全部添加
				...
				*/
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__options'>" +
							...
							?
							("<p class='AddOne' title='添加所选'>&rsaquo;</p>" +
							"<p class='AddAll' title='全部添加'>&raquo;</p>" + 
							"<p class='RemoveOne' title='删除选定'>&lsaquo;</p>" + 
							"<p class='RemoveAll' title='全部删除'>&laquo;</p>") 
							:
							("<p class='AddOne' title='添加所选'>&lsaquo;</p>" +
							"<p class='AddAll' title='全部添加'>&laquo;</p>" +
							"<p class='RemoveOne' title='删除选定'>&rsaquo;</p>" +
							"<p class='RemoveAll' title='全部删除'>&raquo;</p>")
							) +
						"</div>" +
						"<div class='ms2side__select'>" +
				...
				// SELECT optgroup - ADD ALL OPTGROUP AS OPTION (选择组或添加所有组)
