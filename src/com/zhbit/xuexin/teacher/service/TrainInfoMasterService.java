 ...
 *@version 1.0
 */
public interface TrainInfoMasterService {
    /**
     * @Title: getList
     ...
     * @return int
     */
    int save(TrainInfoMaster info, String userId, String trainsDateStr);
     ...
     * @return void
     */
    void update(TrainInfoMaster info, TrainInfoMaster oldInfo, String trainsDateStr);
    /**
     * @Title: delete
     * @Description: TODO(删除。)
     * @author lry
     ...
     */
    ExportExcelVO exportExcelList(Page<TrainInfoMaster> page);
