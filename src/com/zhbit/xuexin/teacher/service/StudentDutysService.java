 ...
 *@version 1.0
 */
public interface StudentDutysService {
    /**
     * @Title: getList
     ...
     * @return int
     */
    int save(StudentDutys info, String userId);
     ...
     */
     ...
     int update(StudentDutys info, StudentDutys oldInfo);
    /**
     * @Title: delete
     * @Description: TODO(删除。)
     * @author lry
     ...
     */
    ExportExcelVO exportExcelList(Page<StudentDutys> page);
